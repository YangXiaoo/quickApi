package com.quickapi.server.common.tools;
...
public class DateFormatUtils {
    ...
    public static String formatDate(Date date,String format){
        return formatDate(DateTool.date2String(date), format);
    }
    ...
    public static String formatDate(String value){
        return getFormat(DATE_FORMAT2).format(DateTool.string2Date(value, DATE_FORMAT2));
    }
    ...
    public static String formatDate(Date value){
        return formatDate(DateTool.date2String(value));
    }
