      ...
      <div style="margin-top: 70px">
        <el-tabs :tab-position="'left'">
          <el-tab-pane label="文档">
            <div>
              <el-button type="success" style="width: 10%">{{ selectType }}</el-button>
              ...
              >
                ...
                <el-tab-pane label="Body" name="Body">
                  ...
                  >
                    ...
                    <el-radio label="application/json"
                      >application/json</el-radio
                    >
